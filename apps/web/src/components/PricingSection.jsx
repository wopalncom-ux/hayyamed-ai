...
const BASE = [
  ...
  { id: 'growth', name: 'Growth', price: 'QAR 599', period: '/month', color: '#00e5a0', popular: true,
  ...
  return (
    <section style={{ maxWidth: '960px', margin: '0 auto', padding: '80px 24px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))', gap: '14px' }}>
        {plans.map(p => (
          <div key={p.id} style={{ padding: '24px', background: p.popular ? 'rgba(0,229,160,.04)' : '#0c0f1a', border: `1px solid ${p.popular ? 'rgba(0,229,160,.25)' : '#1a2235'}`, borderRadius: '10px', position: 'relative' }}>
