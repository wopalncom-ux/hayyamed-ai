  ...
  return (
    <div style={{ background: '#07090f', color: '#e2e8f0', minHeight: '100vh', fontFamily: 'system-ui, sans-serif', overflowX: 'hidden' }}>
      ...
      <header style={{ position: 'relative', zIndex: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '18px 24px', maxWidth: '1100px', margin: '0 auto' }}>
        <Link href="/" style={{ fontWeight: 900, fontSize: '18px', color: '#e2e8f0', textDecoration: 'none' }}>Hayya<span style={{ color: '#00e5a0' }}> AI</span></Link>
        <div style={{ display: 'flex', gap: '18px', alignItems: 'center' }}>
          <Link href="/" style={{ fontSize: '13px', color: '#94a3b8', textDecoration: 'none' }}>Home</Link>
          <Link href="/register" style={{ fontSize: '13px', fontWeight: 700, color: '#07090f', background: '#00e5a0', padding: '8px 16px', borderRadius: '8px', textDecoration: 'none' }}>Start free</Link>
        </div>
      </header>
      ...
      <section style={{ position: 'relative', textAlign: 'center', padding: '72px 24px 56px' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '760px', margin: '0 auto' }}>
          <div style={{ display: 'inline-block', fontSize: '11px', fontWeight: 800, letterSpacing: '0.14em', color: '#00e5a0', border: '1px solid rgba(0,229,160,.3)', borderRadius: '999px', padding: '6px 14px', marginBottom: '22px' }}>BUILT &amp; OPERATED BY HAYYA MED AI</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '14px' }}>
          {[['3', 'Channels — WhatsApp, Instagram, Web'], ['24/7', 'AI agents that never sleep'], ['100%', 'Data hosted in Qatar'], ['2025', 'Founded in Doha']].map(([n, l], i) => (
            <Reveal key={l} delay={i * 90} style={{ ...card, textAlign: 'center', padding: '22px 16px' }}>
              <div style={{ fontSize: '30px', fontWeight: 900, color: '#00e5a0' }}>{n}</div>
      ...
      <section style={{ ...wrap, marginBottom: '64px' }}>
        <Reveal style={{ ...card, display: 'flex', gap: '24px', alignItems: 'center', flexWrap: 'wrap' }}>
          <div style={{ width: '96px', height: '96px', borderRadius: '50%', background: 'linear-gradient(135deg,#00e5a0,#3b82f6)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '34px', fontWeight: 900, color: '#07090f', flexShrink: 0 }}>AA</div>
          <div style={{ flex: 1, minWidth: '260px' }}>
            <div style={{ fontSize: '11px', fontWeight: 800, letterSpacing: '0.12em', color: '#00e5a0', marginBottom: '6px' }}>FOUNDER</div>
      ...
      <section style={{ position: 'relative', textAlign: 'center', padding: '72px 24px', borderTop: '1px solid #1a2235', background: '#0c0f1a' }}>
        <Reveal>
          ...
          <Link href="/register" style={{ display: 'inline-block', padding: '14px 36px', background: '#00e5a0', borderRadius: '8px', color: '#07090f', textDecoration: 'none', fontSize: '15px', fontWeight: 800 }}>Create your free account →</Link>
        </Reveal>
      </section>
