...
export default function Reports() {
  ...
  const sendWhatsApp = () => {
    const text = encodeURIComponent(`*Hayya AI Report*\n\nTotal Leads: ${totalLeads}\nBooked: ${booked}\nBooking Rate: ${bookingRate}%\n\nTop Channel: ${channelStats[0]?.name || 'N/A'}\n\nGenerated by Hayya AI`)
              ...
              <div style={{background:'#0f1520', border:'1px solid #1a2235', padding:'24px', borderRadius:'4px'}}>
                <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', marginBottom:'20px'}}>
                  <div>
                    ...
                    <div style={{fontSize:'11px', color:'#7a8fa6', marginTop:'3px'}}>Generated by Hayya AI · {new Date().toLocaleDateString()}</div>
                  </div>
