...
export const api = {
  ...
  uploadMedia: async (file) => {
    ...
    const r = await authFetch('/media/upload', { method: 'POST', body: fd })
  ...
  generateClientAutomation: (id, description) => request(`/agency/clients/${id}/automations/generate`, { method: 'POST', body: JSON.stringify({ description }) }),
  createClientAutomationFlow: (id, dto) => request(`/agency/clients/${id}/automations`, { method: 'POST', body: JSON.stringify(dto) }),
